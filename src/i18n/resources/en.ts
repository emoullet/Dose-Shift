export const en = {
  translation: {
    ...
    pvtPrototype: {
      ...
      summaryCaution: 'These values are derived only from the in-memory attempts. Each timeout counts as a candidate lapse and uses a conventional 30,000 ms analytical value in the median and mean reciprocal RT; it is not a measured response. Values are not persisted and have no medical interpretation.',
      validResponses: 'Valid responses',
      falseStarts: 'False starts',
      timeouts: 'Timeouts',
      candidateLapses: 'Candidate lapses (≥355 ms, including timeouts)',
