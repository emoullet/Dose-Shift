export const en = {
  translation: {
    ...
    studySetup: {
      ...
      editFormTitle: 'Edit draft study',
      ...
      updated: 'Draft changes saved locally. The study remains inactive.',
    ...
    pvtPrototype: {
      ...
      warningDescription: 'This instrument has not been validated on this hardware. Its timestamp is a software activation proxy, not a measurement of physical light onset. Results stay in memory, are not medical scores, and must not be used for study conclusions.',
      ...
      countdownOrientationChanged: 'The countdown was cancelled because orientation changed. Settle the phone in landscape, then start again.',
      countdownVisibilityLost: 'The countdown was cancelled because the page was hidden. Keep it visible, then start again.',
      countdownFocusLost: 'The countdown was cancelled because the page lost focus. Return to this page, then start again.',
      ...
      countdownTitle: 'PVT technical countdown',
      ...
      stimulus: 'NOW',
      runningHelp: 'Touching before software stimulus activation or under {{milliseconds}} ms is a false start. No response for {{timeoutSeconds}} seconds is a timeout.',
      summaryTitle: 'Technical summary',
      summaryCaution: 'These values are derived only from the in-memory attempts. Each timeout counts as a candidate lapse and uses a conventional {{timeoutMilliseconds}} ms analytical value in the median and mean reciprocal RT; it is not a measured response. Values are not persisted and have no medical interpretation.',
      validResponses: 'Valid responses',
      falseStarts: 'False starts',
      timeouts: 'Timeouts',
      candidateLapses: 'Candidate lapses (≥{{milliseconds}} ms, including timeouts)',
      meanReciprocalRt: 'Mean reciprocal RT (1/s)',
      medianRt: 'Median RT (ms), secondary',
      memoryOnly_one: '{{count}} raw attempt retained in memory for prototype {{version}}. Reloading or leaving this page clears it.',
      memoryOnly_other: '{{count}} raw attempts retained in memory for prototype {{version}}. Reloading or leaving this page clears them.',
