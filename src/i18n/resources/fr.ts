export const fr = {
  translation: {
    ...
    pvtPrototype: {
      ...
      countdownVisibilityLost: 'Le compte à rebours a été annulé car la page a été masquée. Gardez-la visible, puis recommencez.',
      countdownFocusLost: 'Le compte à rebours a été annulé car la page a perdu le focus. Revenez sur cette page, puis recommencez.',
      ...
      countdownTitle: 'Compte à rebours technique PVT',
      ...
      summaryCaution: 'Ces valeurs sont calculées uniquement à partir des tentatives conservées en mémoire. Chaque expiration compte comme une réponse lente candidate et reçoit une valeur analytique conventionnelle de {{timeoutMilliseconds}} ms dans la médiane et le TR réciproque moyen ; ce n’est pas une réponse mesurée. Les valeurs ne sont pas enregistrées et n’ont aucune interprétation médicale.',
      validResponses: 'Réponses valides',
      falseStarts: 'Faux départs',
      timeouts: 'Expirations',
      candidateLapses: 'Réponses lentes candidates (≥{{milliseconds}} ms, expirations incluses)',
      meanReciprocalRt: 'TR réciproque moyen (1/s)',
      medianRt: 'TR médian (ms), secondaire',
      memoryOnly_one: '{{count}} tentative brute conservée en mémoire pour le prototype {{version}}. Recharger ou quitter cette page l’efface.',
      memoryOnly_other: '{{count}} tentatives brutes conservées en mémoire pour le prototype {{version}}. Recharger ou quitter cette page les efface.',
